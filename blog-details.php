                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a class="active" href="blog-details.html">Blog View</a></li>
                        ...
                        <div class="col-md-8">
                            <div class="blog-view">
                                <article class="blog blog-single-post">
                                    <h3 class="blog-title"><?php echo $row['blog_name']; ?></h3>
                                    <div class="blog-info clearfix">
                                        <div class="post-left">
                                            <ul>
                                                <li><a href="update.php?id=<?php echo $row['id'] ?>"><i class="fa fa-calendar"></i> <span>update</span></a></li>
                                                <li><a href="delete.php?id=<?php echo $row['id'] ?>"><i class="fa fa-user-o"></i> <span>delete</span></a></li>
                                            </ul>
                                        </div>
                                        <div class="post-right"><a href="#."><i class="fa fa-comment-o"></i>1 Comment</a></div>
                                    </div>
                                    <div class="blog-image">
                                        <a href="#."><?php echo '<img class="img_fluid" src="data:image/jpeg;base64,' . base64_encode($row['blog_image']) . '"/>'; ?></a>
                                    </div>
