            ...
            <div class="content">
                ...
                <?PHP
				   include "../core/DoctorD.php";
					 ...
					 $listeDoctor=$Doctor1D->afficherDoctor();
foreach($listeDoctor as $row){
  ?>
	<tr>
  ...
  <td><form method="POST" action="supprimer_doctor.php">
  <button type="submit" name="supprimer" value="supprimer" class="ajouter">Supprimer</button>
	<input type="hidden" value="<?PHP echo $row['CIN']; ?>" name="Cin">
	 ...
	 <td><a href="modifier_doctor.php?Cin=<?PHP echo $row['CIN']; ?>"> 
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPoll-1">Ajouter 
                              ...
                              <div class="modal fade right" id="modalPoll-1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">
                                  <form name="formajoutdoctor" onsubmit="return ajouter_doctor()" method="POST" action="ajouter_doctor.php">

                                  <div class="modal-content">
                                    <!--Header-->
                                    <div class="modal-header">
                                      <p class="heading lead">Ajouter Un Docteur
                                      </p>
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <div class="md-form">
                                        <label for="form79textarea">Specialite</label>
                                        <input name="Specialite" type="text" id="form79textarea" class="md-textarea form-control" rows="3">
                                      </div>
                                      
                                      <div class="md-form">
                                        <label for="form79textarea">Pass</label>
                                        <input name="Pass" type="password" id="form79textarea" class="md-textarea form-control" rows="3">
                                      </div>
                                      <div class="md-form">
                                        <label for="form79textarea">Salaire</label>
                                        <input name="Salaire" type="number" id="form79textarea" class="md-textarea form-control" rows="3">
                                      </div>
                                    </div>
