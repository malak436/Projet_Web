        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="assets/img/logo.png" width="35" height="35" alt=""> <span>Venuscare</span>
				</a>
			</div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
							<a href="#"><i class="fa fa-money"></i> <span>Evénements </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="add-event.php">Ajouter un événement</a></li>
								<li><a href="add-cat.php">Ajouter une catégorie</a></li>
								<li><a class="active" href="listeevent.php">Liste des événements</a></li>
