 ...
 if(isset($_GET['id']))
{
 try{
        ...
        $query=$pdo->prepare("select event.*, categorie.libelle_cat FROM event, categorie where id=? and event.idcat=categorie.idcat");
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title"><?php echo utf8_decode($row['titre']); ?></h3>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-blog-area">
                        ...
                        <div class="blog-post-thumbnail">
                            <img src="img/<?php echo utf8_decode($row['img']); ?>" alt="">
                            <!-- Post Date -->
                            <div class="post-date">
                                <a href="#">Date début : <?php echo utf8_decode($row['datedebut']); ?>    -    Date fin : <?php echo utf8_decode($row['datefin']); ?></a>
                            </div>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <div class="post-author">
                             ...
                             <div class="post-meta">
                                <h5>Lieu du déroulement</h5>
                            <p  class="headline mb-0"><?php echo utf8_decode($row['lieu']); ?> </p>
                            <hr>
                            <h5>Catégorie</h5>
                            <p  class="headline mb-0"><?php echo utf8_decode($row['libelle_cat']); ?> </p>
                           <hr>
                                <h5>Nombre de participants</h5>
                                <p  class="post-author-name"><?php echo utf8_decode($row['nbrparticipants']); ?></p> 
                            <hr>
                            <h5>Description</h5>
                    ...
                    <div class="medilife-blog-sidebar-area">
                        ...
                        <div class="medilife-catagories-card mb-50">
                            ...
                            <ul class="catagories-menu">
                                <li><a href="Evenement.php?cat=0">Toutes les catégories</a></li>
                                 <?php
                                            try{
                                                $query=$pdo->prepare(
                                        ...
                                        ?>
                                         <li><a href="Evenement.php?cat=<?php echo $row['idcat']; ?>"><?php echo utf8_decode($row['libelle_cat']); ?></a></li>
