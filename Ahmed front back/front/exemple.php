...
<!-- Mirrored from preview.colorlib.com/theme/voyage/tours.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 Nov 2020 08:41:57 GMT -->
<head>
                        ...
                        <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                            <a href="#" class="block-5" style="background-image: url('images/tour-1.jpg');">
                                <div class="text">
                                    ...
                                    <h3 class="heading"><?php echo $row['ville'] ;?></h3>
                                    <div class="post-meta">
                            ...
                            <a style="margin-left:30px"class="btn btn-warning" href="ajoutReservation.php?id=<?PHP echo $row['id']; ?>">Réserver</a>
            ...
            <div class="col-lg-4 sidebar">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="categories">
                        ...
                        <li><a href="#">camping <span>(22)</span></a></li>
                        <li><a href="#">Cruises <span>(37)</span></a></li>
                        <li><a href="#">hike <span>(42)</span></a></li>
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>We aim to delight visitors with our various programs And multiple events</p>
                </div>
            </div>
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
...
<!-- Mirrored from preview.colorlib.com/theme/voyage/tours.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 Nov 2020 08:42:10 GMT -->
</html>