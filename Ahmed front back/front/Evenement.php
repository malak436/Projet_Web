...
if(isset($_GET['cat'])&&($_GET['cat']!=0))
{
 try{
        ...
        $query=$pdo->prepare("select * FROM event where idcat=? order by id ASC");
        $query->execute(array($_GET['cat']));
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Liste des évenements </h3>
                        <p></p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-blog-area bg-gray mb-50">
                                ...
                                <div class="blog-post-thumbnail">
                                    <img src="img/<?php echo utf8_decode($row['img']); ?>" width = "350" height="300" alt="">
                                    <!-- Post Date -->
                                    <div class="post-date">
                                        <a href="#"><?php echo utf8_decode($row['datedebut']); ?></a>
                                    </div>
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    ...
                                    <a href="viewevenement.php?id=<?php echo utf8_decode($row['id']); ?>" class="headline"><?php echo utf8_decode($row['titre']); ?></a>
                                    <p>Lieu du déroulement : <?php echo utf8_decode($row['lieu']); ?></p>
